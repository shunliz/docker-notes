...
* 删除目录：默认情况下只允许删除空目录，如果要删除有内容的目录需要加上`recursive=true`参数。
  ...
  | 12 | curl'\[\[\[\[[http://127.0.0.1:2379/v2/keys/foo\_dir?dir=true'-XDELETE\]\(http://127.0.0.1:2379/v2/keys/foo\_dir?dir=true'-XDELETE\]\(http://127.0.0.1:2379/v2/keys/foo\_dir?dir=true'-XDELETE\]\(http://127.0.0.1:2379/v2/keys/foo\_dir?dir=true'-XDELETE\)\]\(http://127.0.0.1:2379/v2/keys/foo\_dir?dir=true'-XDELETE\]\(http://127.0.0.1:2379/v2/keys/foo\_dir?dir=true'-XDELETE\]\(http://127.0.0.1:2379/v2/keys/foo\_dir?dir=true'-XDELETE\]\(http://127.0.0.1:2379/v2/keys/foo\_dir?dir=true'-XDELETE\)\)\]\(http://127.0.0.1:2379/v2/keys/foo\_dir?dir=true'-XDELETE\]\(http://127.0.0.1:2379/v2/keys/foo\_dir?dir=true'-XDELETE\]\(http://127.0.0.1:2379/v2/keys/foo\_dir?dir=true'-XDELETE\]\(http://127.0.0.1:2379/v2/keys/foo\_dir?dir=true'-XDELETE\)\]\(http://127.0.0.1:2379/v2/keys/foo\_dir?dir=true'-XDELETE\]\(http://127.0.0.1:2379/v2/keys/foo\_dir?dir=true'-XDELETE\]\(http://127.0.0.1:2379/v2/keys/foo\_dir?dir=true'-XDELETE\]\(http://127.0.0.1:2379/v2/keys/foo\_dir?dir=true'-XDELETE\)\)\)\](http://127.0.0.1:2379/v2/keys/foo_dir?dir=true'-XDELETE]%28http://127.0.0.1:2379/v2/keys/foo_dir?dir=true'-XDELETE]%28http://127.0.0.1:2379/v2/keys/foo_dir?dir=true'-XDELETE]%28http://127.0.0.1:2379/v2/keys/foo_dir?dir=true'-XDELETE%29]%28http://127.0.0.1:2379/v2/keys/foo_dir?dir=true'-XDELETE]%28http://127.0.0.1:2379/v2/keys/foo_dir?dir=true'-XDELETE]%28http://127.0.0.1:2379/v2/keys/foo_dir?dir=true'-XDELETE]%28http://127.0.0.1:2379/v2/keys/foo_dir?dir=true'-XDELETE%29%29]%28http://127.0.0.1:2379/v2/keys/foo_dir?dir=true'-XDELETE]%28http://127.0.0.1:2379/v2/keys/foo_dir?dir=true'-XDELETE]%28http://127.0.0.1:2379/v2/keys/foo_dir?dir=true'-XDELETE]%28http://127.0.0.1:2379/v2/keys/foo_dir?dir=true'-XDELETE%29]%28http://127.0.0.1:2379/v2/keys/foo_dir?dir=true'-XDELETE]%28http://127.0.0.1:2379/v2/keys/foo_dir?dir=true'-XDELETE]%28http://127.0.0.1:2379/v2/keys/foo_dir?dir=true'-XDELETE]%28http://127.0.0.1:2379/v2/keys/foo_dir?dir=true'-XDELETE%29%29%29\)\) |
  | :--- | :--- |
